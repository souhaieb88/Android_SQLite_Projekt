...
import com.sqlite.R;
import com.sqlite.adapter.ListCompaniesAdapter;
...
public class ListCompaniesActivity extends Activity implements OnItemLongClickListener, OnItemClickListener, OnClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		intent.putExtra(ListProjectsActivity.EXTRA_SELECTED_COMPANY_ID, clickedCompany.getId());
	...
	private void showDeleteDialogConfirmation(final Company clickedCompany) {
        ...
        alertDialogBuilder.setMessage("Sind Sie sicher, dass Sie wirklich löschen möchten \""+clickedCompany.getName()+"\" company ?");
